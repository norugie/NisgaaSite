    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <form class="edit_form_validate" action="../functions/interaction.php?interaction=true&page=<?php echo $_GET['page']; ?>&editAboutProgram=true" method="POST">
                <input type="text" id="edit_about_programs_id" name="about_programs_id" value="<?php echo $page_info['id']; ?>">
                <input type="text" id="edit_about_programs_name" name="about_programs_name" value="<?php echo $page_info['web_id']; ?>">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
