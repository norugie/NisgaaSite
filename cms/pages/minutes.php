<?php 
    ...
    $links = $district->minutesList($database);

 ?>

<?php require '../components/modals/new_minutes.php'; ?>
<?php require '../components/modals/edit_minutes.php'; ?>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <center>
                            <?php if($_SESSION['type'] != 3){ ?>
                                <button type="button" class="btn bg-blue waves-effect" data-toggle="modal" data-target="#new-minutes-modal" style="display: inline-block;"><i class="material-icons">add</i><span>NEW MINUTES</span></button>
                            <?php } ?>
                        </center>
                    </div>
                </div>
                            ...
                            <?php foreach($links as $link): ?>
                                <tr>
                                    ...
                                    <?php if($_SESSION['type'] != 3){ ?>
                                        ...
                                        <?php } else { ?>
                                            <td><center><button type="button" class="btn bg-cyan waves-effect" data-type="reopen-minutes" data-id="<?php echo $link['id']; ?>" data-name="<?php echo str_replace(' ', '%20', $link['link_name']); ?>" onclick="alertDesign(this);"><i class="material-icons">check</i><span>REACTIVATE</span></button></center></td>
                                        <?php } ?>
                                    <?php } ?>
                                </tr>
                            <?php endforeach; ?>
