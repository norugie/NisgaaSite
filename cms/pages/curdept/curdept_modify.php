<div class="header">
    <div class="row clearfix">
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <center>
                <button type="button" class="btn bg-blue waves-effect" style="display: inline-block;" onclick="window.location.href='interaction.php?tab=web&subtab=curriculum&page=<?php echo $_GET['page']; ?>'">PAGE VIEW</button>
            </center>
        </div>
    </div>     
</div>
