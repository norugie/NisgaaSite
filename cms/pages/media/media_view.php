    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <center>
                ...
                <button type="button" class="btn bg-green waves-effect" style="display: inline-block; margin-top: 4px; margin-left: 5px;" onclick="window.location.href='post.php?tab=post&page=media'"><i class="material-icons">mode_edit</i></button>
