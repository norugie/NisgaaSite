        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <form class="new_form_validate" action="../functions/post.php?post=true&addMedia=true" method="POST" enctype="multipart/form-data">
                ...
                <div class="row clearfix" <?php if($_SESSION['school'] == 3 || $_SESSION['school'] == 4 || $_SESSION['school'] == 5 || $_SESSION['school'] == 6){ echo "hidden"; } ?>>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="demo-radio-button">
                            <input type="radio" name="media_sm_autopost" id="sm_opt_1" class="radio-col-blue-grey with-gap" value="No" checked>
                            <label for="sm_opt_1">No</label>
                            <input type="radio" name="media_sm_autopost" id="sm_opt_2" class="radio-col-blue-grey with-gap" value="Yes">
                ...
                <?php if($_SESSION['school'] == 11 || $_SESSION['type'] == 1){ ?>
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label for="media_ssd_autopost">Post on School District Superintendent Page?</label>
                            <div class="demo-radio-button">
                                <input type="radio" name="media_ssd_autopost" id="ssd_opt_1" class="radio-col-blue-grey with-gap" value="No" checked>
                                <label for="ssd_opt_1">No</label>
                                <input type="radio" name="media_ssd_autopost" id="ssd_opt_2" class="radio-col-blue-grey with-gap" value="Yes">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <textarea rows="2" class="form-control no-resize" id="media_content" name="media_content"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
