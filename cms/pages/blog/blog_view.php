<div class="header">
    <div class="row clearfix">
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <center>
                <button type="button" class="btn bg-blue waves-effect" style="display: inline-block; margin-top: 5px;" onclick="window.location.href='post.php?tab=post&page=blog'"><i class="material-icons">list</i><span>LIST</span></button>
