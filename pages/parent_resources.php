<?php $links = $site->linkList($database, 'Parent Resources', 2); ?>
<div class="col-md-9">
    <!-- PARENT RESOURCE INFO CONTENT -->
    <section>
        <div class="row">
            <div class="col-md-12">
                <p class="lead">The following are resources that parents for the students of the district can use for general purposes:</p>
            </div>
        </div>
    </section>
