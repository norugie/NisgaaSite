<?php $links = $site->linkList($database, 'Student Resources', $schoolContent); ?>
<div class="col-md-9">
    <!-- STUDENT RESOURCE INFO CONTENT -->
    <section>
        <div class="row">
            <div class="col-md-12">
                <p class="lead">The following are resources that students from the district can use for general purposes:</p>
            </div>
        </div>
    </section>
