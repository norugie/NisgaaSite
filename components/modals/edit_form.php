            ...
            <div class="modal-body">
                ...
                <div class="row clearfix">
                    ...
                    <form class="edit_form_validate_file" action="../functions/district.php?district=true&editForm=true" method="POST" enctype="multipart/form-data">
                            <input type="text" id="edit_form_id_file" name="edit_link_id">
                            <input type="text" id="edit_form_id_name_file" name="edit_link_id_name">
                            <input type="text" id="edit_form_id_file_file" name="edit_link_id_file">
                            <input type="text" id="edit_form_id_type_file" name="edit_link_id_type">
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <form class="edit_form_validate_link" action="../functions/district.php?district=true&editForm=true" method="POST">
                            <input type="text" id="edit_form_id_link" name="edit_link_id">
                            <input type="text" id="edit_form_id_name_link" name="edit_link_id_name">
                            <input type="text" id="edit_form_id_type_link" name="edit_link_id_type">
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
