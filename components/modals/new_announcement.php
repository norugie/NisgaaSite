...
<div class="modal fade" id="new-announcement-modal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #607D8B; color: #fff; margin: 0; padding: 15px;">
                ...
                <h4 class="modal-title" id="largeModalLabel">New Announcement Post</h4>
            </div>
                        ...
                        <form class="new_form_validate" action="../functions/post.php?post=true&addAnnouncement=true" method="POST">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="2" class="form-control no-resize" id="announcement_desc" name="announcement_desc" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
